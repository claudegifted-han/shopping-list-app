#!/usr/bin/env python3
"""
DSHS AI Agent System - 파일럿 테스트 도구
...
class PilotTester:
    ...
    def run_quick_test(self) -> None:
        ...
        print("\n" + "="*60)
        print("🚀 DSHS AI Agent System - 빠른 파일럿 테스트")
    ...
    def run_full_test(self) -> None:
        """전체 테스트"""
        print("\n" + "="*60)
        print("🚀 DSHS AI Agent System - 전체 파일럿 테스트")
    ...
    def run_agent_test(self, agent: str) -> None:
        ...
        print("\n" + "="*60)
        print(f"🚀 DSHS AI Agent System - {agent} 에이전트 테스트")
...
def main():
    parser = argparse.ArgumentParser(
        description="DSHS AI Agent System - 파일럿 테스트"
    )
